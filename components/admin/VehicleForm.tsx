    ...
    <form onSubmit={onSubmit} className="space-y-10 border border-edgeline-border bg-edgeline-black p-8">
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          ...
          <input id="badge" placeholder="Featured, Rare..." value={badge} onChange={(e) => setBadge(e.target.value)} className={inputClass} />
        </div>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="mt-4 font-body text-sm text-edgeline-white/70"
        />
        {uploading && <p className="mt-2 text-xs text-edgeline-white/50">Uploading...</p>}
      </div>
